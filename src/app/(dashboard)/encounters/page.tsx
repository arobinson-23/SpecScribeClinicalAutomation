                ...
                return (
                  <tr key={enc.id} className="hover:bg-white/5 transition-colors">
                    <td className="px-4 py-3">
                      ...
                      <div className="text-xs text-white/40 font-mono">MRN: {enc.patient.mrn}</div>
                    </td>
                    ...
                    <td className="px-4 py-3 text-right">
                      <Link
                        ...
                        className="text-blue-400 hover:text-blue-300 font-bold text-[10px] uppercase tracking-wider"
                      >
                        Open Note →
                      </Link>
                    </td>
